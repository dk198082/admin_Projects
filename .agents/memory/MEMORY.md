...
- [E2E testing behind Entra ID](e2e-testing-behind-entra.md) — inject a signed connect.sid session into the Postgres session table to test the auth-gated UI; clean up after.
- [Graph API permissions gotchas](graph-api-permissions.md) — consent takes minutes to hit tokens; sign-in logs API needs Entra P1/P2 license, distinguish 403s by error.code.
